...
class _AddNewClientScreenState extends State<AddNewClientScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(StringManager.addNewClient),
      ),
      body: Padding(
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              if(_controllers.first.text.isNotEmpty){
                                for (var controller in _controllers){
                                  phoneNumbers.add(PhoneEntity(phoneNumber: controller.text));
                                }
                              }
                              ...
                              AddNewSupplierParameter addNewSupplierParameters = AddNewSupplierParameter(
                                ...
                                order: 0,
                                companyId: int.tryParse(supplierCompanyIdController.text),
                                groupId: int.tryParse(supplierGroupIdController.text),
                                sectionId: int.tryParse( supplierSectionIdController.text),
