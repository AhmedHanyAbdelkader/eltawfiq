...
class AddSupplierFromContcts extends StatefulWidget {
  const AddSupplierFromContcts({super.key, required this.contact});

  final Contact contact;

  @override
  State<AddSupplierFromContcts> createState() => _AddSupplierFromContctsState();
}

class _AddSupplierFromContctsState extends State<AddSupplierFromContcts> {
