...
class GetAllCompanySuppliersUseCase extends BaseUseCase<List<SupplierEntity>, int>{
  SuppliersBaseRepository suppliersBaseRepository;
  GetAllCompanySuppliersUseCase(this.suppliersBaseRepository);

  @override
  Future<Either<Failure, List<SupplierEntity>>> call(int parameter) async
  {
    return await suppliersBaseRepository.getCompanySuppliers(parameter);
  }
