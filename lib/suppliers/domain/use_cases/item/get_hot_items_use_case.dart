...
class GetHotItemsUseCase extends BaseUseCase<List<ItemEntity>, int>{
  SuppliersBaseRepository suppliersBaseRepository;
  GetHotItemsUseCase(this.suppliersBaseRepository);
  @override
  Future<Either<Failure, List<ItemEntity>>> call(int parameter) async{
    return await suppliersBaseRepository.getHotItems(parameter);
  }
