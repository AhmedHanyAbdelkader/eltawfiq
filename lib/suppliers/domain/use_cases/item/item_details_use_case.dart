...
class ItemDetailsUseCase extends BaseUseCase<ItemEntity, int>{
  SuppliersBaseRepository suppliersBaseRepository;
  ItemDetailsUseCase(this.suppliersBaseRepository);

  @override
  Future<Either<Failure, ItemEntity>> call(int parameter) async{
    return await suppliersBaseRepository.getItemDetails(parameter);
  }
