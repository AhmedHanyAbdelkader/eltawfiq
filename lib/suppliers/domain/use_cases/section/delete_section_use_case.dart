...
class DeleteSectionUseCase extends BaseUseCase<int, int>{
  SuppliersBaseRepository suppliersBaseRepository;
  DeleteSectionUseCase(this.suppliersBaseRepository);

  @override
  Future<Either<Failure, int>> call(int parameter) async {
    return await suppliersBaseRepository.deleteSection(parameter);
  }
