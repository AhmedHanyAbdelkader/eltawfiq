...
class GetAllClientsUseCase extends BaseUseCase<List<SupplierEntity>, NoParameters>{
  SuppliersBaseRepository suppliersBaseRepository;
  GetAllClientsUseCase(this.suppliersBaseRepository);

  @override
  Future<Either<Failure, List<SupplierEntity>>> call(NoParameters parameter) async
  {
    return await suppliersBaseRepository.getClients(parameter);
  }
