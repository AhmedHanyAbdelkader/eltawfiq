...
class DeleteGroupUseCase extends BaseUseCase<int, int>{
  SuppliersBaseRepository suppliersBaseRepository;
  DeleteGroupUseCase(this.suppliersBaseRepository);

  @override
  Future<Either<Failure, int>> call(int parameter) async {
    return await suppliersBaseRepository.deleteGroup(parameter);
  }
